...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::prefix('reservation')->group(function () {
            ...
            Route::post('store{id}', [\App\Http\Controllers\admin\ReservationController::class, 'store'])->name('admin_reservation_store');
            Route::get('edit/{id}', [\App\Http\Controllers\admin\ReservationController::class, 'edit'])->name('admin_reservation_edit');
            Route::post('itemupdate/{id}', [\App\Http\Controllers\admin\ReservationController::class, 'itemupdate'])->name('admin_reservation_items_update');
