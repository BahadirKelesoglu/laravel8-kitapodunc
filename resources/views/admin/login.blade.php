...
<script type="text/javascript" src="{{ asset('assets')}}/admin/assets/js/jquery.backstretch.min.js"></script>
<script>
    $.backstretch("{{ asset('assets')}}/admin/assets/img/login-bg.jpg", {speed: 500});
</script>
